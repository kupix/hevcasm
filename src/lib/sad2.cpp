...
template <typename Sample>
static int hevcasm_sad_c_ref4(const Sample *src, intptr_t stride_src, const Sample *ref, intptr_t stride_ref, uint32_t rect)
{
...
template <typename Sample>
static int hevcasm_sad_c_ref8(const Sample *src, intptr_t stride_src, const Sample *ref, intptr_t stride_ref, uint32_t rect)
{
  const int width = rect >> 8;
  const int height = rect & 0xff;
  int sad = 0;
...
template <typename Sample>
static int hevcasm_sad_c_ref16(const Sample *src, intptr_t stride_src, const Sample *ref, intptr_t stride_ref, uint32_t rect)
{
  const int width = rect >> 8;
  const int height = rect & 0xff;
  int sad = 0;
...
template <typename Sample>
static int hevcasm_sad_c_ref32(const Sample *src, intptr_t stride_src, const Sample *ref, intptr_t stride_ref, uint32_t rect)
{
  const int width = rect >> 8;
  const int height = rect & 0xff;
  int sad = 0;
...
template <typename Sample>
static int hevcasm_sad_c_ref64(const Sample *src, intptr_t stride_src, const Sample *ref, intptr_t stride_ref, uint32_t rect)
{
  const int width = rect >> 8;
  const int height = rect & 0xff;
  int sad = 0;
...
static int hevcasm_sad_c_ref(const Sample *src, intptr_t stride_src, const Sample *ref, intptr_t stride_ref, uint32_t rect)
{
  ...
  if (width == 4)
    return hevcasm_sad_c_ref4(src, stride_src, ref, stride_ref, rect);
  else if (width == 8)
    return hevcasm_sad_c_ref8(src, stride_src, ref, stride_ref, rect);
  else if (width == 16)
    return hevcasm_sad_c_ref16(src, stride_src, ref, stride_ref, rect);
  else if (width == 32)
    return hevcasm_sad_c_ref32(src, stride_src, ref, stride_ref, rect);
  else if (width == 64)
    return hevcasm_sad_c_ref64(src, stride_src, ref, stride_ref, rect);
