...
static int compute_satd2(const Sample *pA, intptr_t strideA, const Sample *pB, intptr_t strideB)
{
...
template <typename Sample>
static int compute_satd4(const Sample *pA, intptr_t strideA, const Sample *pB, intptr_t strideB)
{
...
template <typename Sample>
static int compute_satd8(const Sample *pA, intptr_t strideA, const Sample *pB, intptr_t strideB)
{
  int k, i, j, jj, sad = 0;
...
void hevcasm_populate_hadamard_satd(hevcasm_table_hadamard_satd<Sample> *table, hevcasm_code code)
{
  ...
  {
    *hevcasm_get_hadamard_satd(table, 1) = compute_satd2<Sample>;// compute_satd<2, Sample>;
    *hevcasm_get_hadamard_satd(table, 2) = compute_satd4<Sample>;// compute_satd<4, Sample>;
    *hevcasm_get_hadamard_satd(table, 3) = compute_satd8<Sample>;// compute_satd<8, Sample>;
  }
